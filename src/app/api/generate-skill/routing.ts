...
//
// **아직 생성 경로에 붙이지 않는다.** route.ts는 그대로 전체 코퍼스를 보낸다.
// 선택 주입이 현재 방식보다 나쁘지 않다는 것을 자체 시나리오(6단계)와 비교
// 실험(8단계)에서 확인한 뒤에 붙인다. 근거와 순서는
// `.agents/plans/workstreams/corpus-routing/design.md`에 있다.
//
// 여기서 하는 일은 셋이다.
